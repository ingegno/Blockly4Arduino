...
Blockly.Msg.ARD_LEDUP_HUB = "LedUpKidz V1, destination: ";  // untranslated
...
Blockly.Msg.ARD_LEDUPV3_HUB = "LedUpKidz V3";  // untranslated
Blockly.Msg.ARD_LEDUPV3_HUB_TIP = "LedUpKidzV3 is a gadget with 6 LED and a button that you can program. The gadget works on a small attiny414 microchip, which you can program with the Ingegno programmer";  // untranslated
...
Blockly.Msg.ARD_LEDUPV3_HUBBTN = "Add how to handle the button";
Blockly.Msg.ARD_LEDUP_BTN = "Button";
Blockly.Msg.ARD_LEDUPV3_HUBPIN = "Optional external connection";
Blockly.Msg.ARD_LEDUP_PIN = "PB0 Pin";
